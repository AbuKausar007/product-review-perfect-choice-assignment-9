  ...
  return (
    <section class="px-4 pt-20 pb-24 mx-auto max-w-7xl md:px-2">
      <div class="grid grid-cols-1 gap-24 md:grid-cols-2">
        <div>
          <h1 class="mb-6 text-4xl font-bold text-gray-900 md:text-3xl">
            Basic Questions
          </h1>
          <p class="mt-10 mb-3 font-semibold text-xl text-orange-500">
          ...
          <p class="text-gray-600">
            ...
            purpose. Here we'll show how to use it at a basic level to improve
            accessibility.
          </p>
          <p class="mt-10 mb-3 font-semibold text-xl text-orange-500">
        ...
        <div>
          ...
          <p class="text-gray-600">
            ...
            assistive technologies can recognize.
          </p>
          <p class="mt-10 mb-3 font-semibold text-xl text-orange-500">
